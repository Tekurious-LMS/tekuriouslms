...
import { Cuboid, Upload, Lock } from "lucide-react";

export function ARCreationSection() {
    const templates = [
        { id: 1, title: "3D Model Viewer", desc: "Visualize static assets" },
        { id: 2, title: "Virtual Lab Builder", desc: "Create interactive experiments" },
        ...
        <div className="space-y-4">
            <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                    <h2 className="text-2xl font-semibold">Create Immersive Lessons (AR/VR)</h2>
                ...
                <CardContent className="space-y-6">
                    <div className="grid md:grid-cols-3 gap-4">
                        {templates.map((template) => (
                            <div key={template.id} className="p-4 rounded-lg border border-dashed bg-background/50 flex flex-col items-center text-center space-y-2 opacity-70">
