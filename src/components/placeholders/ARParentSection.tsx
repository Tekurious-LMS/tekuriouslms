    ...
    <div className="space-y-4">
      ...
      <Card className="border-dashed border-2 bg-muted/20">
        <CardHeader>
          ...
          <CardDescription>
            Soon you&apos;ll be able to see what your child is experiencing in
            their immersive learning sessions.
          </CardDescription>
        </CardHeader>
        <CardContent className="flex flex-col items-center justify-center py-12 text-center text-muted-foreground opacity-60">
          ...
          <div className="space-y-2 max-w-md">
            <p className="text-sm">
              View session replays, 3D model interactions, and engagement
              metrics from your child&apos;s AR and VR lessons.
            </p>
          </div>
