...
export function SidebarNavigation({ mobile, collapsed, toggleCollapse }: SidebarProps) {
    ...
    const menuItems = {
        Student: [
            ...
            { label: "Assessments", icon: GraduationCap, href: "/student/assessments" },
            { label: "Progress", icon: Activity, href: "/student/progress" },
            { label: "Immersive Learning", icon: Cuboid, href: "#", disabled: true, badge: "Coming Soon" },
        ],
        Teacher: [
            { label: "Dashboard", icon: LayoutDashboard, href: "/teacher/dashboard" },
            { label: "My Courses", icon: BookOpen, href: "/teacher/courses" },
            { label: "Lessons", icon: FileText, href: "/teacher/lessons" },
            { label: "Assessments", icon: GraduationCap, href: "/teacher/assessments" },
            { label: "Class Progress", icon: BarChart3, href: "/teacher/progress" },
            { label: "Immersive Learning", icon: Cuboid, href: "#", disabled: true, badge: "Coming Soon" },
        ],
        Admin: [
            { label: "Dashboard", icon: LayoutDashboard, href: "/admin/dashboard" },
            { label: "Users", icon: Users, href: "/users" }, // Assuming these routes are admin-scoped internally or prefixed
            { label: "Academic Structure", icon: Layers, href: "/academic-structure" },
            { label: "Teacher Assignment", icon: UserCheck, href: "/admin/assignments" },
            { label: "Reports", icon: ClipboardList, href: "/admin/reports" },
            { label: "Audit Logs", icon: Shield, href: "/audit-logs" },
            { label: "Immersive Analytics", icon: BarChart3, href: "#", disabled: true, badge: "Coming Soon" },
        ],
        Parent: [
            { label: "Dashboard", icon: LayoutDashboard, href: "/parent/dashboard" },
            { label: "Student Progress", icon: Activity, href: "/parent/progress" },
            { label: "Assessments", icon: GraduationCap, href: "/parent/assessments" },
            { label: "Notifications", icon: BellRing, href: "/parent/notifications" },
            { label: "Immersive Preview", icon: Cuboid, href: "#", disabled: true, badge: "Coming Soon" },
        ],
    };
