...
export function SidebarNavigation({ mobile, collapsed, toggleCollapse }: SidebarProps) {
    ...
    const menuItems = {
        Student: [
            ...
            { label: "My Courses", icon: BookOpen, href: "/student/courses", disabled: true, badge: "Soon" },
            { label: "Assessments", icon: GraduationCap, href: "/student/assessments", disabled: true, badge: "Soon" },
            { label: "Progress", icon: Activity, href: "/student/progress", disabled: true, badge: "Soon" },
            { label: "Immersive Learning", icon: Cuboid, href: "#", disabled: true, badge: "Phase 2" },
        ],
        Teacher: [
            { label: "Dashboard", icon: LayoutDashboard, href: "/teacher/dashboard" },
            { label: "My Courses", icon: BookOpen, href: "/teacher/courses", disabled: true, badge: "Soon" },
            { label: "Lessons", icon: FileText, href: "/teacher/lessons", disabled: true, badge: "Soon" },
            { label: "Assessments", icon: GraduationCap, href: "/teacher/assessments", disabled: true, badge: "Soon" },
            { label: "Class Progress", icon: BarChart3, href: "/teacher/progress", disabled: true, badge: "Soon" },
            { label: "Immersive Learning", icon: Cuboid, href: "#", disabled: true, badge: "Phase 2" },
        ],
        Admin: [
            { label: "Dashboard", icon: LayoutDashboard, href: "/admin/dashboard" },
            { label: "Users", icon: Users, href: "/users", disabled: true, badge: "Soon" },
            { label: "Academic Structure", icon: Layers, href: "/admin/structure" },
            { label: "Teacher Assignment", icon: UserCheck, href: "/admin/assignments", disabled: true, badge: "Soon" },
            { label: "Reports", icon: ClipboardList, href: "/admin/reports", disabled: true, badge: "Soon" },
            { label: "Audit Logs", icon: Shield, href: "/audit-logs", disabled: true, badge: "Soon" },
            { label: "Immersive Analytics", icon: BarChart3, href: "#", disabled: true, badge: "Phase 2" },
        ],
        Parent: [
            { label: "Dashboard", icon: LayoutDashboard, href: "/parent/dashboard" },
            { label: "Student Progress", icon: Activity, href: "/parent/progress", disabled: true, badge: "Soon" },
            { label: "Assessments", icon: GraduationCap, href: "/parent/assessments", disabled: true, badge: "Soon" },
            { label: "Notifications", icon: BellRing, href: "/parent/notifications", disabled: true, badge: "Soon" },
            { label: "Immersive Preview", icon: Cuboid, href: "#", disabled: true, badge: "Phase 2" },
        ],
    };
                ...
                {currentMenu.map((route: any) => {
                    ...
                    return (
                        <Link
                            ...
                            title={collapsed ? route.label : undefined}
                        >
                            <route.icon className={cn("h-5 w-5", collapsed ? "mr-0" : "mr-3", isActive ? "text-primary" : "text-muted-foreground group-hover:text-primary")} />
