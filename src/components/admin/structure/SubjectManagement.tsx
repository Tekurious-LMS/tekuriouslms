    ...
    <Card>
        ...
        <Dialog open={isAddOpen} onOpenChange={setIsAddOpen}>
          ...
          <DialogContent>
            <DialogHeader>
              ...
              <DialogDescription>
                Create a new subject (e.g., &quot;Mathematics&quot;,
                &quot;Physics&quot;).
              </DialogDescription>
            </DialogHeader>
            <div className="py-4">
            ...
            <DialogFooter>
              ...
              <Button onClick={handleAdd} disabled={!newSubjectName.trim()}>
                Create Subject
              </Button>
            </DialogFooter>
          </DialogContent>
            ...
            <TableBody>
              {subjects.map((subj) => (
                <TableRow key={subj.id}>
                  ...
                  <TableCell>
                    <Badge
                      variant={subj.isActive ? "secondary" : "outline"}
                      className={
                        subj.isActive
                  ...
                  <TableCell className="text-right flex items-center justify-end gap-2">
                    <Button
                      ...
                      size="icon"
                      onClick={() =>
                        setEditingParams({ id: subj.id, name: subj.name })
                      }
                    >
                    ...
                    <Switch
                      ...
                      onCheckedChange={(checked) =>
                        onUpdateSubject(subj.id, subj.name, checked)
                      }
                    />
                  </TableCell>
                </TableRow>
      ...
      >
        <DialogContent>
          ...
          <DialogFooter>
            <Button variant="outline" onClick={() => setEditingParams(null)}>
              Cancel
            </Button>
