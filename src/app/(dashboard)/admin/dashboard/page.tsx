...
export default async function AdminDashboard() {
  ...
  const auditLogs = [
    ...
    {
      id: 2,
      action: "Published 'Advanced Physics'",
      actor: "Sarah Jones",
      role: "Teacher",
      time: "1 hour ago",
    },
    ...
    {
      id: 4,
      action: "Added new class: Grade 10-B",
      actor: "Admin User",
      role: "Admin",
      time: "5 hours ago",
    },
          ...
          <div className="grid md:grid-cols-2 gap-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Configure department heads and resources
                </CardDescription>
              </CardHeader>
            ...
            <div className="md:col-span-2">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>
                    Latest teacher allocations to classes and courses
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  <Table>
