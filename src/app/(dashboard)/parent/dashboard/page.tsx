  ...
  const notifications = [
    {
      ...
      message: "Mid-term report cards are now available.",
      time: "2 hours ago",
      type: "academic",
    },
    {
      ...
      message: "Scheduled for Feb 24th at 10:00 AM.",
      time: "1 day ago",
      type: "event",
    },
    {
      ...
      message: "History project is due on Friday.",
      time: "2 days ago",
      type: "alert",
    },
  ];
            ...
            <Card className="border-dashed">
              <CardContent className="flex flex-col items-center justify-center py-8 text-center">
                ...
                <p className="text-sm text-muted-foreground">
                  Detailed progress will appear here once enrollment is active.
                </p>
              </CardContent>
            </Card>
          )}
            ...
            <CardContent className="p-0">
              {recentAssessments.length > 0 ? (
                ...
                <div className="flex flex-col items-center justify-center py-8 text-center">
                  ...
                  <h3 className="text-lg font-semibold mb-2">
                    No recently graded assessments
                  </h3>
                  <p className="text-sm text-muted-foreground">
                    Grades and scores will be listed here.
                  </p>
                </div>
              )}
            </CardContent>
