    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-1">
        ...
        <section className="w-full py-12 md:py-24 lg:py-32 xl:py-48 bg-background relative overflow-hidden">
          {/* Subtle Grid Pattern */}
          <div className="absolute inset-0 bg-grid-slate-200/50 dark:bg-grid-slate-800/20 mask-[linear-gradient(0deg,white,rgba(255,255,255,0.6))] pointer-events-none" />
            ...
            <div className="grid gap-6 lg:grid-cols-[1fr_400px] lg:gap-12 xl:grid-cols-[1fr_600px] items-center">
              <div className="flex flex-col justify-center space-y-4">
                <div className="space-y-2">
                  ...
                  <h1 className="text-3xl font-bold tracking-tighter sm:text-5xl xl:text-6xl/none">
                    ...
                    <span className="text-transparent bg-clip-text bg-linear-to-r from-primary to-emerald-600 dark:to-emerald-400">
                      Schools, Teachers & Students
                    </span>
                  </h1>
                  <p className="max-w-[600px] text-muted-foreground md:text-xl">
                    Manage multi-tenant campuses, deliver live classes, and
                    prepare for the future with upcoming AI and AR/VR
                    integration.
                  </p>
                </div>
                ...
                <div className="flex items-center gap-4 text-sm text-muted-foreground mt-4">
                  ...
                  <div className="flex items-center gap-1">
                    <CheckCircle2 className="h-4 w-4 text-primary" /> Analytics
                    Driven
                  </div>
                </div>
              </div>
              <div className="mx-auto aspect-video overflow-hidden rounded-xl border bg-muted/50 p-4 lg:order-last w-full shadow-2xl shadow-primary/10">
                <div className="w-full h-full bg-background rounded-lg border shadow-sm flex items-center justify-center text-muted-foreground relative group overflow-hidden">
                  ...
                  <div className="absolute inset-0 bg-[linear-gradient(to_right,rgba(255,255,255,0.5),transparent)] opacity-100" />
                  {/* Mock UI Lines */}
        ...
        <section
          id="features"
          className="w-full py-12 md:py-24 lg:py-32 bg-slate-50 dark:bg-slate-900/10 border-y"
        >
          <div className="container px-4 md:px-6 mx-auto">
            ...
            <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
              <Card>
                ...
                <CardContent>
                  <p className="text-muted-foreground">
                    Manage multiple schools, branches, and departments from a
              ...
              <Card>
                ...
                <CardContent>
                  <p className="text-muted-foreground">
                    Create rich curriculum with videos, notes, and interactive
                    content. seamless enrollment logic.
                  </p>
                </CardContent>
              </Card>
              <Card>
                ...
                <CardContent>
                  <p className="text-muted-foreground">
                    Deep insights into student performance, attendance trends,
              ...
              <Card>
                ...
                <CardContent>
                  <p className="text-muted-foreground">
                    Integrated timetable with support for live video sessions
                    and automated attendance.
                  </p>
                </CardContent>
              </Card>
              <Card className="border-primary/50 bg-primary/5">
                ...
                <CardContent>
                  <p className="text-muted-foreground">
                    Immersive 3D models and virtual labs to explain complex
                    concepts visually.
                  </p>
                </CardContent>
              </Card>
              <Card className="border-primary/50 bg-primary/5">
                ...
                <CardContent>
                  <p className="text-muted-foreground">
                    Personalized AI assistance for students to clear doubts
                    24/7.
                  </p>
                </CardContent>
              </Card>
            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <div className="space-y-4">
                ...
                <p className="text-muted-foreground md:text-lg">
                  Our platform adapts to your schedule. Whether you&apos;re a
                  night owl or an early bird, access your course materials,
                  recorded lectures, and assignments 24/7.
                </p>
                <ul className="space-y-2 mt-4">
                  <li className="flex items-center gap-2 text-sm text-foreground/80">
                    <CheckCircle2 className="h-4 w-4 text-primary" /> Offline
                    access support
                  </li>
                  <li className="flex items-center gap-2 text-sm text-foreground/80">
                    <CheckCircle2 className="h-4 w-4 text-primary" />{" "}
          ...
          <div className="container px-4 md:px-6 mx-auto">
            <div className="grid lg:grid-cols-2 gap-12 items-center lg:flex-row-reverse">
              ...
              <div className="space-y-4">
                ...
                <h2 className="text-3xl font-bold tracking-tighter sm:text-4xl">
                  Built for Students, Teachers & Institutions
                </h2>
                <p className="text-muted-foreground md:text-lg">
                  Tekurious LMS connects the dots between all stakeholders.
                  Teachers can focus on teaching, students on learning, and
                  admins on managing—all in perfect harmony.
                </p>
                <div className="grid gap-2 text-sm mt-4">
                  ...
                  <div className="p-3 bg-background rounded-lg border shadow-sm">
                    ...
                    <p className="text-muted-foreground">
                      Real-time fee and enrollment insights.
                    </p>
                  </div>
                </div>
              </div>
        ...
        <section
          id="immersive"
          className="w-full py-12 md:py-24 lg:py-32 bg-background overflow-hidden relative"
        >
          <div className="absolute inset-x-0 top-0 h-40 bg-linear-to-b from-muted/50 to-transparent pointer-events-none" />
          <div className="container px-4 md:px-6 mx-auto relative z-10">
            <div className="text-center max-w-3xl mx-auto space-y-4 mb-16">
              ...
              <p className="text-muted-foreground md:text-xl">
                Step inside the textbook. Experience complex concepts through
                interactive virtual simulations and augmented reality models.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              <Card className="group overflow-hidden border-muted-foreground/20 hover:border-primary/50 transition-colors bg-card/50 backdrop-blur-sm">
                <div className="aspect-video bg-muted/30 relative flex items-center justify-center overflow-hidden">
                  ...
                  <Badge className="absolute top-4 right-4 bg-background/80 backdrop-blur-sm text-foreground border shadow-sm">
                    Coming Soon
                  </Badge>
                </div>
                <CardHeader>
                ...
                <CardContent className="text-sm text-muted-foreground">
                  Mix volatile chemicals and observe reactions without any
                  physical danger. safe, repeatable, and cost-effective.
                </CardContent>
                <CardFooter>
                  <Button
                    variant="ghost"
              ...
              <Card className="group overflow-hidden border-muted-foreground/20 hover:border-primary/50 transition-colors bg-card/50 backdrop-blur-sm relative top-0 md:-top-8 shadow-xl">
                ...
                <CardContent className="text-sm text-muted-foreground">
                  Visualize the human heart, brain, and skeletal systems in
                  high-fidelity 3D. Rotate, zoom, and dissect virtually.
                </CardContent>
                <CardFooter>
                  <Button
                    variant="default"
              ...
              <Card className="group overflow-hidden border-muted-foreground/20 hover:border-primary/50 transition-colors bg-card/50 backdrop-blur-sm">
                ...
                <CardContent className="text-sm text-muted-foreground">
                  Walk through the streets of Ancient Rome or visit the Pyramids
                  of Giza. History lesson reimagined.
                </CardContent>
                <CardFooter>
                  <Button
                    variant="ghost"
