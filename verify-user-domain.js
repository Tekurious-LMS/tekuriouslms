...
async function main() {
  ...
  try {
    ...
    if (userWithRelations) {
      ...
      console.log(
        `   - Has student profile: ${!!userWithRelations.studentProfile}`,
      );
      console.log(
        `   - Parent mappings: ${userWithRelations.parentMappings.length}`,
      );
      console.log(
        `   - Student mappings: ${userWithRelations.studentMappings.length}`,
      );
    } else {
